...
acc = Account("카리나", 10000)
print(f"desposit --> {acc.deposit(3000)}")     # 인스턴스 메소드 호출

# 클래스 메소드 호출
Account.from_dict({"owner" : "윈터", "balance" : 10000})
...
if Account.is_valid_amount(amount):
    ...
    print(f"최소 금액을 만족하지 않았습니다")
"""

# from_dict 활용
response = [
    {"owner" : "닝닝", "balance" : 20000},
    {"owner" : "윈터"},
    {"owner" : "카리나", "balance" : 55000},
]
