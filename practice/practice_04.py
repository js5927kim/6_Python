...
f = np.array(list6).round().astype(int)
print(f"{f}")
...
print(f"{prices.max()}, {dates[max_idx]}, {prices.min()}, {dates[min_idx]}")
...
print(f"종목별 평균가 : {matrix.mean(axis=1)}")
print(f"날짜별 평균가 : {matrix.mean(axis=0)}")